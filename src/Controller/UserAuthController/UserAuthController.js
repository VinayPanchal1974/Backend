...
const userAuthModel = require("../../Model/UserAuthModel/UserAuthModel");
...
exports.userSignup = async (req, res) => {
  try {
    ...
    const dbRes = await userAuthModel.create(data);
    if (dbRes) {
      res.json({
        status: "success",
...
exports.userSignin = async (req, res) => {
  try {
    ...
    const dbRes = await userAuthModel.findOne(filter, {
      name: 1,
      email: 1,
      password: 1,
    });
